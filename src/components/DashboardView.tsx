    ...
    <div className="space-y-8 animate-fade-in">
      <div className="flex flex-col gap-1.5 md:hidden">
        ...
        <p className="text-sm font-medium text-gray-500">
          {language === "en" 
            ? "Summary of inventory activity and stock status."
            : "Ringkasan aktiviti inventori dan status stok."}
        </p>
      </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm md:col-span-1 flex flex-col justify-between">
          <div>
            ...
            <p className="mt-3 text-xs font-semibold leading-relaxed text-gray-500">
              {language === "en"
                ? "Inventory tracking for small teams with item management, movement history, and bilingual labels."
                : "Penjejakan inventori untuk pasukan kecil dengan pengurusan barang, sejarah pergerakan, dan label dwi bahasa."}
            </p>
          </div>
          ...
          <div className="mt-6 border-t border-gray-50 pt-5">
            <span className="text-[10px] font-extrabold tracking-wider text-brand-gold uppercase">
              {language === "en" ? "BND Currency" : "Mata Wang BND"}
            </span>
